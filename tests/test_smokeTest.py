...
class TestSmokeTest():
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(1208, 854)
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("icorrectUserName")
  ...
  def test_homePageSpotlightandAction(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1208, 854)
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Marcos")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Kolin")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("BlueCage")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("CEO")
    self.driver.find_element(By.NAME, "submit").click()
    WebDriverWait(self.driver, 10).until(
      expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".myinput:nth-child(2)"))
    )
